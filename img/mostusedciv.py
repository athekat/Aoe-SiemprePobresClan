...
# Civ Mapping (might change with new civs DLC). El current civ mapping está en el discord de libre:match
civ_list = {
    ...
    20: "Incas", 21: "Indians", 22: "Italians", 23: "Japanese", 24: "Khmer",
